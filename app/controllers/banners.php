...
class banners extends connectData {
    ...
    function getContent( $parans = null, $debug = false ) {
        ...
        $whe = 'status=:status and item_id=:item_id';
        $ord = 'indice';

        $sql = "select $col from personalizacao_atributo where $whe order by $ord";
